export function Animations() {
    return (
        ...
        <style dangerouslySetInnerHTML={{ __html: `
            ...
            @keyframes nominal-pulse { 0%, 100% { color: rgba(52, 211, 153, 0.85); text-shadow: 0 0 0 rgba(52, 211, 153, 0); } 50% { color: rgba(52, 211, 153, 1); text-shadow: 0 0 12px rgba(52, 211, 153, 0.7), 0 0 22px rgba(52, 211, 153, 0.45); } }
            ...
            .animate-nominal-pulse { animation: nominal-pulse 2s ease-in-out infinite; }
